  ...
  template: `
    <div fxLayout="column" fxLayoutGap="16px" [fxHide]="hidden">
      <div [ngClass]="'array-layout-toolbar'">
        <h2 class="custom-layout__title">{{ label }}</h2>
        <span fxFlex></span>
        <mat-icon
...
'
      ...
      <div
        *ngFor="
        ...
        "
      >
        <mat-card class="custom-layout__item-array">
          <mat-card-content>
          ...
          <mat-card-actions *ngIf="isEnabled()">
            ...
            <button
              *ngIf="uischema?.options?.['showSortButtons']; s"
              class="item-down"
              mat-button
              [disabled]="last"
              (click)="down(idx)"
...
export class CustomRendererLayoutArray
